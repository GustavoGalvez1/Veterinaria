...
<body>
	<div class="contenedor">
		<h2>LLENA CORRECTAMENTE LOS QUE SE TE PIDE</h2>
		<form action="" method="post">
			...
			<div class="form-group">
				<input type="text" name="telefono" placeholder="Tipo de mascota" class="input__text">
				<input type="text" name="ciudad" placeholder="Nombre de la mascota" class="input__text">
			</div>
			<div class="form-group">
